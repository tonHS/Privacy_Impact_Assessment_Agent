...
- **PIPEDA** (Federal) — 10 Schedule 1 principles, breach notification (s. 10.1), third-party accountability
- **BC PIPA** (SBC 2003, c. 63) — Consent structure, cross-border transfers (s. 33.1), 30-day access rights
- **Alberta PIPA** (SA 2003, c. P-6.5) — Breach notification (s. 34.1), employee-specific provisions, 45-day access rights
- **Quebec Law 25** (Bill 64) — Mandatory PIA before project launch (s. 3.3), Privacy by Default (s. 9), portability and deletion rights, significant penalties
- **GDPR** — DPIA requirements (Art. 35), automated decision rights (Art. 22)
